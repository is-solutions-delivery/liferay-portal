...
public abstract class BaseUserAccountFullNameDefinitionResourceImpl
	implements UserAccountFullNameDefinitionResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/headless-admin-user/v1.0/user-account-full-name-definition'  -u 'test@liferay.com:test'
	 */
	...
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {
			@io.swagger.v3.oas.annotations.tags.Tag(
				name = "UserAccountFullNameDefinition"
			)
		}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/user-account-full-name-definition")
