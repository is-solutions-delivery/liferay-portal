...
public interface MessageBoardThreadResource {
	...
	public Page<MessageBoardThread>
			getMessageBoardSectionFilteredMessageBoardThreadsPage(
				Long messageBoardSectionId, String tag, String search,
	...
	public static class MessageBoardThreadResourceImpl
		...
		public Page<MessageBoardThread>
			...
			HttpInvoker.HttpResponse httpResponse =
				getMessageBoardSectionFilteredMessageBoardThreadsPageHttpResponse(
					messageBoardSectionId, tag, search, aggregations,
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + _builder._contextPath +
						"/o/headless-delivery/v1.0/message-board-sections/{messageBoardSectionId}/filtered-message-board-threads");
