...
package headless.mail.internal.graphql.mutation.v1_0;
...
public class Mutation {
	...
	@GraphQLField
	public Mail sendMail(@GraphQLName("mail") Mail mail) throws Exception {
		return _applyComponentServiceObjects(
			_mailResourceComponentServiceObjects,
			this::_populateResourceContext,
			mailResource -> mailResource.sendMail(mail));
	}
