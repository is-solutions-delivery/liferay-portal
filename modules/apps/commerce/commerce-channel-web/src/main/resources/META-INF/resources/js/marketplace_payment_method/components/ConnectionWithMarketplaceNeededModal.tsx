...
export default function ConnectionWithMarketplaceNeededModal(
	...
	return (
		<ClayModal center observer={props.observer} status="info">
			...
			<ClayModal.Body>
				<p>
					{Liferay.Language.get("you-are-trying-to-add-a-new-payment-method-through-the-marketplace-but-the-connection-has-not-been-established-yet-please-go-to-instance-settings-to-enable-the-connection-into-dxp")}
				</p>
				&ensp;
				<div>
