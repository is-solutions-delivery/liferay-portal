		...
		return (
			<div className="d-flex flex-column justify-content-between payment-methods-modal-body">
				<div>
						...
						<ClayManagementToolbar.ItemList>
							...
							<ClayManagementToolbar.Item>
								...
								>
									<ClayIcon
										symbol={
											sort.SORT_ICON[sort.sortDirection]
										}
									/>
								</ClayButton>
							</ClayManagementToolbar.Item>
					...
					{loading ? (
						<div
							className="align-items-center d-flex justify-content-center payment-methods-modal-body-empty-state pt-4"
						>
											...
											>
												...
												>
													...
													<div>
														...
														<div
															className="d-flex my-2 payment-method-app-search-results-card-category"
														>
															{!!categories?.length && (
																<>
				...
				<div className="d-flex justify-content-end px-4 py-4 w-100">
					<ClayPaginationBarWithBasicItems
						...
						ellipsisBuffer={1}
						ellipsisProps={{ 'aria-label': Liferay.Language.get('more'), 'title': Liferay.Language.get('more') }}
