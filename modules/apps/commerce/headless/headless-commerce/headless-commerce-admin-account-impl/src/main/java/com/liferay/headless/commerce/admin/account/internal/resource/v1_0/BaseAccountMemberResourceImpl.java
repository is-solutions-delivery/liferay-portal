...
public abstract class BaseAccountMemberResourceImpl
	...
	public void create(
		...
		UnsafeFunction<AccountMember, AccountMember, Exception>
			accountMemberUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("externalReferenceCode")) {
				accountMemberUnsafeFunction = accountMember ->
		...
		if (accountMemberUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for AccountMember");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				accountMembers, accountMemberUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				accountMembers, accountMemberUnsafeFunction::apply);
		}
		else {
			for (AccountMember accountMember : accountMembers) {
				accountMemberUnsafeFunction.apply(accountMember);
			}
		}
	}
	...
	public void setContextBatchUnsafeBiConsumer(
		UnsafeBiConsumer
			<Collection<AccountMember>,
			 UnsafeFunction<AccountMember, AccountMember, Exception>, Exception>
