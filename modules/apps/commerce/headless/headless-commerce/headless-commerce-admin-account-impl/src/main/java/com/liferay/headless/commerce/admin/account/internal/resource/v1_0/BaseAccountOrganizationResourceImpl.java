...
public abstract class BaseAccountOrganizationResourceImpl
	...
	public void create(
		...
		UnsafeFunction<AccountOrganization, AccountOrganization, Exception>
			accountOrganizationUnsafeFunction = null;
		...
		if (StringUtil.equalsIgnoreCase(createStrategy, "INSERT")) {
			if (parameters.containsKey("externalReferenceCode")) {
				accountOrganizationUnsafeFunction = accountOrganization ->
					postAccountByExternalReferenceCodeAccountOrganization(
		...
		if (accountOrganizationUnsafeFunction == null) {
			throw new NotSupportedException(
				"Create strategy \"" + createStrategy +
					"\" is not supported for AccountOrganization");
		}

		if (contextBatchUnsafeBiConsumer != null) {
			contextBatchUnsafeBiConsumer.accept(
				accountOrganizations, accountOrganizationUnsafeFunction);
		}
		else if (contextBatchUnsafeConsumer != null) {
			contextBatchUnsafeConsumer.accept(
				accountOrganizations, accountOrganizationUnsafeFunction::apply);
		}
		else {
			for (AccountOrganization accountOrganization :
					accountOrganizations) {

				accountOrganizationUnsafeFunction.apply(accountOrganization);
			}
		}
	}
