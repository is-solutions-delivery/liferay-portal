...
.adt-apps-search-results .app-apps-results-card:hover {
	color: var(--black);
}
...
@media screen and (max-width: 599px) {
	...
	.adt-apps-search-results .apps-search-results-card {
		height: 281px;
	}
}
...
<div class="adt-apps-search-results">
	<div class="apps-count color-neutral-3 d-md-block d-none pb-4">
	...
	<div class="cards-container pb-6">
		<#if entries?has_content>
			<#list entries as curCPCatalogEntry>
				...
				<a class="apps-search-results-card bg-white d-flex flex-column mb-0 p-3 rounded text-decoration-none" href=${friendlyURL} style="color: var(--black);">
