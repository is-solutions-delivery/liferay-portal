...
<div class="d-flex font-size-paragraph-small solutions-details-breadcrumb">
	<div class="breadcrumb-left-desktop d-flex flex-wrap">
		<a class="d-flex pt-1" href="${layoutSetCanonicalURL}">
