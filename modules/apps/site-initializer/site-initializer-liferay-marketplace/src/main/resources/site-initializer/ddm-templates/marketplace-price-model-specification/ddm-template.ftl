...
>
	<@liferay_ui.panel
		...
		markupView="lexicon"
		persistState=true
		title="${cpSpecificationOptionsSearchFacetDisplayContext.getParameterName()?split('-')[0]?upper_case} ${cpSpecificationOptionsSearchFacetDisplayContext.getParameterName()?split('-')[1]?upper_case}">
