...
public class BundleSiteInitializer implements SiteInitializer {
	...
	public void initialize(long groupId) throws InitializationException {
		...
		try {
			...
			_invoke(() -> _addSegmentEntry(serviceContext));
	...
	private void _addSegmentEntry(ServiceContext serviceContext)
		throws Exception {

		String json = SiteInitializerUtil.read(
			"/site-initializer/segments.json", _servletContext);
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			if (segmentsEntry == null) {
				_segmentsEntryLocalService.addSegmentsEntry(
					StringUtil.merge(
						JSONUtil.toStringArray(
							jsonObject.getJSONArray("segments")),
						StringPool.NEW_LINE),
					SiteInitializerUtil.toMap(jsonObject.getString("nameMap")),
					SiteInitializerUtil.toMap(
						jsonObject.getString("descriptionMap")),
				...
				_segmentsEntryLocalService.updateSegmentsEntry(
					...
					StringUtil.merge(
						JSONUtil.toStringArray(
							jsonObject.getJSONArray("segments")),
						StringPool.NEW_LINE),
					SiteInitializerUtil.toMap(jsonObject.getString("name")),
					SiteInitializerUtil.toMap(
						jsonObject.getString("descriptionMap")),
					jsonObject.getBoolean("active", true),
