...
const CoverageInfoForm = () => {
	...
	const handleChangeVehicleInfo = (
		...
		const vehicles = form.vehicles.map((vehicle:any, vehicleIndex:number) => {
				...
				>
					...
					>
						{uninsuredOrUnderinsuredMBIOptions[stateInfoForm].map(
							(uninsuredOrUnderinsuredMBIOption:any, index:number) => (
								<ClaySelect.Option
									className="font-weight-bold text-center text-primary"
									key={index}
									label={
				...
				>
					...
					>
						{uninsuredOrUnderinsuredMPDOptions[stateInfoForm].map(
							(uninsuredOrUnderinsuredMPDOption:any, index:number) => (
								<ClaySelect.Option
									className="font-weight-bold text-center text-primary"
									key={index}
									label={
