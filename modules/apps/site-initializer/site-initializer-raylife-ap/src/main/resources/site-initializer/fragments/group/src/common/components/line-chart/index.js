					...
					<ClayChart
						...
						tooltip={{
							contents: (data) => {
								...
								return hasPersonalizedTooltip
									? `<div class="line-chart-tooltip w-100 bg-neutral-0 d-flex font-weight-bold rounded-sm p-2"><span class="d-flex font-weight-normal mr-2 w-100">${title}</span> ${value}</div>`
									: `<div class="line-chart-tooltip w-100 bg-neutral-0 d-flex font-weight-bold rounded-sm p-2"><span class="d-flex font-weight-normal mr-2 w-100">${title}</span> $${value}</div>`;
							},
						}}
					/>
