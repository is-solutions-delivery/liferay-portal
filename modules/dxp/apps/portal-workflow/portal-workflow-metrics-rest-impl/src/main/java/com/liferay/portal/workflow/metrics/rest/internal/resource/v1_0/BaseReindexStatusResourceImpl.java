...
public abstract class BaseReindexStatusResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/portal-workflow-metrics/v1.0/reindex/statuses/export-batch'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.Path("/reindex/statuses/export-batch")
	@javax.ws.rs.POST
	@javax.ws.rs.Produces("application/json")
	@Override
	public Response postReindexStatusesPageExportBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineExportTaskResource.postExportTask(
				ReindexStatus.class.getName(), callbackURL, contentType,
				fieldNames)
		).build();
	}
