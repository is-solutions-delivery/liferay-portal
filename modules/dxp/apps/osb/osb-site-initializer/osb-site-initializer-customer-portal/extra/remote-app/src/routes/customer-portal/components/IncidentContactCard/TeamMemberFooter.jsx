...
import IncidentContactsButton from '../../pages/Project/TeamMembers/components/ManageProductUsers/components/IncidentContactsButton';
		...
		try {
			...
			const mappedContacts = highPriorityContactsFiltered.map(
				(contact, index) => {
					...
					return {
						contact:
							r_userToHighPriorityContacts_user
			...
			console.error('Error high priority contacts', error);
		}
	};
