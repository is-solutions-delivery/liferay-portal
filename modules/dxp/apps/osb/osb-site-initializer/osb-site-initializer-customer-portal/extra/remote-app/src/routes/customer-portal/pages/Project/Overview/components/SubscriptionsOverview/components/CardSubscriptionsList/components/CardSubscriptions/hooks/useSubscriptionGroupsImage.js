...
export default function useSubscriptionGroupsImage(selectedSubscriptionGroup) {
	...
	return `${liferayWebDAV}/assets/navigation-menu/${
		SUBSCRIPTION_IMAGE_FILE[selectedSubscriptionGroup] || 'portal_icon.svg'
	}`;
}
