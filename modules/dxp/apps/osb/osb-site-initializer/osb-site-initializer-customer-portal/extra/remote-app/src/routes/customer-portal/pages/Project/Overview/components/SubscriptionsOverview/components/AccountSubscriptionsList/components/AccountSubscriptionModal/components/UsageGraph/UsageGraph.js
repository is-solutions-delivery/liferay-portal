...
const UsageGraph = ({accountSubscriptionUsage}) => {
	return (
		<>
			<div className="d-flex justify-content-center">
				<BarChart
					cursor="pointer"
					data={
						accountSubscriptionUsage.data
							.getAccountSubscriptionUsage.annualSubscriptions
					}
					height={350}
					margin={{
						bottom: 0,
			...
			<div className="d-flex flex-row-reverse m-2">
				<h6>
					...
					{
						accountSubscriptionUsage.data
							.getAccountSubscriptionUsage.currentConsumption
					}
				</h6>
			</div>
		</>
