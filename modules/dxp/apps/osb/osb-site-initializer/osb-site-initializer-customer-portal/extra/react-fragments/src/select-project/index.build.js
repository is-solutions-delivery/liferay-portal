    ...
    (() => {
        var e = {
                ...
                5691: (e, t, n) => {
                    ...
                    var r = n(4674), a = n(4993), l = n(5089), o = n(3688), i = n.n(o), u = __REQUIRE__('__REACT_PROVIDER__$react'), c = u && u.__esModule ? u.default : u, s = __REQUIRE__('__REACT_PROVIDER__$react').useEffect, f = __REQUIRE__('__REACT_PROVIDER__$react').useMemo, d = __REQUIRE__('__REACT_PROVIDER__$react').useState;
                    function p(e, t) {
                        return function (e) {
                            if (Array.isArray(e))
                                return e;
                    ...
                    var y = Liferay.ThemeDisplay.getCDNBaseURL() + '/o/admin-theme/images/clay/icons.svg', h = function () {
                    ...
                    function b() {
                        var e, t = p(d([]), 2), n = t[0], o = t[1], u = p(d(''), 2), m = u[0], b = u[1], g = p(d(!1), 2), E = g[0], w = g[1], _ = f(function () {
                                return new URLSearchParams(window.location.search).get('kor_id');
                            }, []), O = (null == n ? void 0 : n.filter(function (e) {
                                var t;
                                return null == e || null === (t = e.label) || void 0 === t ? void 0 : t.toLowerCase().includes(null == m ? void 0 : m.toLowerCase());
                            })) || [];
                        O.length || O.push({
                        ...
                        var x = n.filter(function (e, t) {
                                return t <= 19;
                            }), k = (null === (e = n.find(function (e) {
                                return e.name === _;
                            })) || void 0 === e ? void 0 : e.label) || '';
                        return s(function () {
                            Liferay.once('customer-portal-select-user-loading', function (e) {
                                var t = e.detail.accountBriefs;
                                t && o(t.map(function (e) {
                                    var t = e.externalReferenceCode, n = e.name, r = ''.concat(window.location.origin).concat(h(), '/overview?kor_id=').concat(t);
                                    return {
                                        className: 'c-py-3 m-0 '.concat(_ === t ? 'selected-item' : 'unselect-item'),
                                        href: r,
                                        label: n,
                                        name: t,
                                        symbolRight: _ === t ? 'check' : ''
                                    };
                                }));
                            });
                        }, [_]), c.createElement(a.ad, {
                            alignmentPosition: [
                                'tl',
                                'br'
                            ],
                            footerContent: c.createElement('div', {
                                className: i()('all-projects c-py-2', { 'show-arrow': E }),
                                onClick: v,
                                onMouseEnter: function () {
                                    return w(!0);
                                },
                            ...
                            }, c.createElement('a', null, c.createElement('p', { className: 'c-pl-4 my-0 py-2' }, E && c.createElement(l.default, {
                                className: 'mr-2',
                                spritemap: y,
                                symbol: 'order-arrow-left'
                            }), 'All Projects'))),
                            items: m ? O : x,
                            menuElementAttrs: { className: 'custom-projects-dropdown '.concat(O.length > 10 ? 'show-scroll' : 'hide-scroll', ' c-p-0') },
                            onSearchValueChange: b,
                            searchProps: { placeholder: 'Search' },
                            searchValue: m,
                            searchable: n.length >= 10,
                            spritemap: y,
                            trigger: c.createElement(r.default, {
                                className: 'shadow-none',
                                displayType: 'unstyled'
                            }, c.createElement('div', { className: 'align-items-center d-flex' }, c.createElement('h5', { className: 'm-0 selected-project-title' }, k ? c.createElement(c.Fragment, null, k) : c.createElement('div', {
