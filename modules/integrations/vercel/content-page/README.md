...
1. Go to the **Structures** page and create add a new `Content` structure;
   <br />![create structure 01](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-01.png)

1. Edit the structure name and make it available for all spaces:
   <br />![create structure 02](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-02.png)

1. Edit the `Title` field:
   <br />![create structure 03](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-03.png)

1. Edit the `Content` field:
   <br />![create structure 04](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-04.png)

1. Edit the `Summary` field:
   <br />![create structure 05](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-05.png)

1. Edit the `Image` field:
   <br />![create structure 06](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-06.png)

1. Edit the `Location Map Url` field:
   <br />![create structure 07](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-07.png)

1. Edit the `Location Name` field:
   <br />![create structure 08](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-08.png)

1. Edit the `Registration Link` field:
   <br />![create structure 09](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-09.png)

1. Publish it.

Now you're able to create new `Event`s:

![create structure 10](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-10.png)

Save the ID present in the URL and Global Menu:

![create structure 11](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/create-structure-11.png)
...
- Under `Objects > [ YOUR CUSTOM CONTENT ENTITY ] > [ YOUR CUSTOM CONTENT ENTITY ]`, add `VIEW` permission.
    <br />![guest permissions](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/content-page/public/images/guest-permissions.png)
