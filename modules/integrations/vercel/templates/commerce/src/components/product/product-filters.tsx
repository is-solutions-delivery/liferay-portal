            ...
            <div className="p-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-1">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => selectAllFilters(filterCategory)}
                    >
                      Select All
                    </Button>
                    ...
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => clearAllFilters(filterCategory)}
                    >
                      Clear
                    </Button>
                  </div>
              ...
              {expanded && (
                <div className="mt-4 space-y-3">
                  {filterCategory.options.map((option, optionIndex) => {
                    const optionValue =
                    ...
                    return (
                      ...
                      >
                        <Checkbox
                          id={optionValue}
                          checked={specificationValues.includes(optionValue)}
                          onCheckedChange={(checked) =>
                            handleCategoryChange(checked as boolean, option)
                          }
                        />
                        <Label
                          htmlFor={optionValue}
