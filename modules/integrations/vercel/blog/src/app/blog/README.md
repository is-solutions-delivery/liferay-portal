...
- Under `Objects > Blog > Blog`, add `VIEW` permission.
    <br />![guest permissions](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/blog/public/images/space-details.png/guest-permissions.png)
...
1. Define:
    ...
    - `LIFERAY_SPACE_ID`: Your CMS Space ID (aka Group ID, or Scope ID), you can get it in the Space settings.
      <br />![space details](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/blog/public/images/space-details.png)

1. Feel free to add Blog content for your local testing:
   <br />![add blog content](https://github.com/liferay/liferay-portal/tree/master/modules/integrations/vercel/blog/public/images/space-details.png/add-blog-content.png)
