...
import com.liferay.portal.tools.service.builder.test.compat700.model.impl.ArrayableEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat700.model.impl.ArrayableEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat700.service.persistence.ArrayableEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat700.service.persistence.ArrayableEntryUtil;
		...
		if (list == null) {
			try {
				if ((start == QueryUtil.ALL_POS) &&
					...
					long[][] groupIdsPages = (long[][])_split(
						groupIds, _databaseInMaxParameters);
...
// LIFERAY-SERVICE-BUILDER-HASH:1555620647