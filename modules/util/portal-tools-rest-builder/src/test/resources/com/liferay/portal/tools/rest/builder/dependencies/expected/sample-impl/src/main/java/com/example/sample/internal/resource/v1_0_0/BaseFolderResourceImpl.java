...
public abstract class BaseFolderResourceImpl
	...
	@Override
	public Page<Folder> getFolderPage() throws Exception {
	...
	@io.swagger.v3.oas.annotations.tags.Tags(value = {})
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/folder/{folderId}")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Folder getFolder(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@javax.validation.constraints.NotNull
			@javax.ws.rs.PathParam("folderId")
			Long folderId)
		throws Exception {
	...
	public void create(
			Collection<Folder> folders, Map<String, Serializable> parameters)
		throws Exception {
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseFolderResourceImpl.class);
