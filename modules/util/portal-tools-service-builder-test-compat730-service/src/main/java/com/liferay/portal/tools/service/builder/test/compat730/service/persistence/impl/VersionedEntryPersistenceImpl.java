...
import com.liferay.portal.tools.service.builder.test.compat730.exception.NoSuchVersionedEntryException;
import com.liferay.portal.tools.service.builder.test.compat730.model.VersionedEntry;
import com.liferay.portal.tools.service.builder.test.compat730.model.impl.VersionedEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat730.model.impl.VersionedEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat730.service.persistence.VersionedEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat730.service.persistence.VersionedEntryUtil;
...
public class VersionedEntryPersistenceImpl
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new VersionedEntryModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", VersionedEntry.class.getName()));
	...
	private static class VersionedEntryModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(
					versionedEntryModelImpl, columnNames, original);
			}
		...
		private static Object[] _getValue(
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] =
						versionedEntryModelImpl.getColumnOriginalValue(
							columnName);
				}
				else {
...
// LIFERAY-SERVICE-BUILDER-HASH:1948889154