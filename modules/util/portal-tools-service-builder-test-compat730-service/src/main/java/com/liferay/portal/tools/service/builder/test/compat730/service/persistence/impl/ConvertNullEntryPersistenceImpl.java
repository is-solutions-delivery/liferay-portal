...
import com.liferay.portal.tools.service.builder.test.compat730.model.impl.ConvertNullEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat730.service.persistence.ConvertNullEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat730.service.persistence.ConvertNullEntryUtil;
...
public class ConvertNullEntryPersistenceImpl
	...
	public List<ConvertNullEntry> findAll(
		...
		if (useFinderCache) {
			list = (List<ConvertNullEntry>)dummyFinderCache.getResult(
				finderPath, finderArgs, this);
		}
	...
	public void afterPropertiesSet() {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			...
			new ConvertNullEntryModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", ConvertNullEntry.class.getName()));
	...
	private static class ConvertNullEntryModelArgumentsResolver
