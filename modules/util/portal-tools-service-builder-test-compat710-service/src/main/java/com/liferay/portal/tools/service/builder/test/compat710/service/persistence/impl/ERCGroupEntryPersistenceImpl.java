...
import com.liferay.portal.tools.service.builder.test.compat710.exception.DuplicateERCGroupEntryExternalReferenceCodeException;
import com.liferay.portal.tools.service.builder.test.compat710.exception.NoSuchERCGroupEntryException;
import com.liferay.portal.tools.service.builder.test.compat710.model.ERCGroupEntry;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ERCGroupEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ERCGroupEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ERCGroupEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ERCGroupEntryUtil;
...
public class ERCGroupEntryPersistenceImpl
	...
	public void cacheResult(ERCGroupEntry ercGroupEntry) {
		entityCache.putResult(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(ERCGroupEntry ercGroupEntry) {
		...
		clearUniqueFindersCache((ERCGroupEntryModelImpl)ercGroupEntry, true);
	}
	...
	public void clearCache(List<ERCGroupEntry> ercGroupEntries) {
		...
		for (ERCGroupEntry ercGroupEntry : ercGroupEntries) {
			...
			clearUniqueFindersCache(
				(ERCGroupEntryModelImpl)ercGroupEntry, true);
		}
	}
	...
	protected void clearUniqueFindersCache(
		ERCGroupEntryModelImpl ercGroupEntryModelImpl, boolean clearCurrent) {
		...
		if ((ercGroupEntryModelImpl.getColumnBitmask() &
			 _finderPathFetchByUUID_G.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				ercGroupEntryModelImpl.getOriginalUuid(),
				ercGroupEntryModelImpl.getOriginalGroupId()
			};
	...
	public ERCGroupEntry updateImpl(ERCGroupEntry ercGroupEntry) {
		...
		if (!ERCGroupEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {ercGroupEntryModelImpl.getUuid()};
			...
			args = new Object[] {
				ercGroupEntryModelImpl.getUuid(),
				ercGroupEntryModelImpl.getCompanyId()
			};
			...
			if ((ercGroupEntryModelImpl.getColumnBitmask() &
				...
				args = new Object[] {ercGroupEntryModelImpl.getUuid()};
			...
			if ((ercGroupEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ercGroupEntryModelImpl.getOriginalUuid(),
					ercGroupEntryModelImpl.getOriginalCompanyId()
				};
		...
		clearUniqueFindersCache(ercGroupEntryModelImpl, false);
	 ...
	 */
	@Override
	public ERCGroupEntry fetchByPrimaryKey(Serializable primaryKey) {
		...
		ERCGroupEntry ercGroupEntry = (ERCGroupEntry)serializable;
		...
		if (ercGroupEntry == null) {
			...
			try {
				...
				if (ercGroupEntry != null) {
					...
					entityCache.putResult(
						ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
						ERCGroupEntryImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception exception) {
				entityCache.removeResult(
	...
	@Override
	public Map<Serializable, ERCGroupEntry> fetchByPrimaryKeys(
		...
		Map<Serializable, ERCGroupEntry> map =
			new HashMap<Serializable, ERCGroupEntry>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (ercGroupEntry != null) {
				map.put(primaryKey, ercGroupEntry);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (ERCGroupEntry)serializable);
				}
			}
		}
		...
		sb.append(_SQL_SELECT_ERCGROUPENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (ERCGroupEntry ercGroupEntry :
					(List<ERCGroupEntry>)query.list()) {

				map.put(ercGroupEntry.getPrimaryKeyObj(), ercGroupEntry);

				cacheResult(ercGroupEntry);

				uncachedPrimaryKeys.remove(ercGroupEntry.getPrimaryKeyObj());
			}
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCGroupEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCGroupEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCGroupEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCGroupEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);

		_finderPathCountAll = new FinderPath(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCGroupEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			ERCGroupEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_finderPathFetchByUUID_G = new FinderPath(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCGroupEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCGroupEntryImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByUUID_G",
			new String[] {String.class.getName(), Long.class.getName()},
			ERCGroupEntryModelImpl.UUID_COLUMN_BITMASK |
			ERCGroupEntryModelImpl.GROUPID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			new String[] {String.class.getName(), Long.class.getName()},
			ERCGroupEntryModelImpl.UUID_COLUMN_BITMASK |
			ERCGroupEntryModelImpl.COMPANYID_COLUMN_BITMASK);
		...
		_finderPathFetchByG_ERC = new FinderPath(
			ERCGroupEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCGroupEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCGroupEntryImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByG_ERC",
			new String[] {Long.class.getName(), String.class.getName()},
			ERCGroupEntryModelImpl.GROUPID_COLUMN_BITMASK |
			ERCGroupEntryModelImpl.EXTERNALREFERENCECODE_COLUMN_BITMASK);
	...
	private static final String _SQL_SELECT_ERCGROUPENTRY_WHERE_PKS_IN =
		"SELECT ercGroupEntry FROM ERCGroupEntry ercGroupEntry WHERE ercGroupEntryId IN (";
...
// LIFERAY-SERVICE-BUILDER-HASH:-583253626