...
import com.liferay.portal.tools.service.builder.test.compat710.exception.DuplicateERCCompanyEntryExternalReferenceCodeException;
import com.liferay.portal.tools.service.builder.test.compat710.exception.NoSuchERCCompanyEntryException;
import com.liferay.portal.tools.service.builder.test.compat710.model.ERCCompanyEntry;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ERCCompanyEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ERCCompanyEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ERCCompanyEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ERCCompanyEntryUtil;
...
public class ERCCompanyEntryPersistenceImpl
	...
	public void cacheResult(ERCCompanyEntry ercCompanyEntry) {
		entityCache.putResult(
			ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public void clearCache(ERCCompanyEntry ercCompanyEntry) {
		...
		clearUniqueFindersCache(
			(ERCCompanyEntryModelImpl)ercCompanyEntry, true);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if ((ercCompanyEntryModelImpl.getColumnBitmask() &
			 _finderPathFetchByC_ERC.getColumnBitmask()) != 0) {

			Object[] args = new Object[] {
				ercCompanyEntryModelImpl.getOriginalCompanyId(),
	...
	public ERCCompanyEntry updateImpl(ERCCompanyEntry ercCompanyEntry) {
		...
		if (!ERCCompanyEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {ercCompanyEntryModelImpl.getUuid()};
			...
			args = new Object[] {
				ercCompanyEntryModelImpl.getUuid(),
				ercCompanyEntryModelImpl.getCompanyId()
			};
			...
			if ((ercCompanyEntryModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					ercCompanyEntryModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {ercCompanyEntryModelImpl.getUuid()};
		...
		entityCache.putResult(
			ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCCompanyEntryImpl.class, ercCompanyEntry.getPrimaryKey(),
			ercCompanyEntry, false);

		clearUniqueFindersCache(ercCompanyEntryModelImpl, false);
	 ...
	 */
	@Override
	public ERCCompanyEntry fetchByPrimaryKey(Serializable primaryKey) {
		...
		ERCCompanyEntry ercCompanyEntry = (ERCCompanyEntry)serializable;
		...
		if (ercCompanyEntry == null) {
			...
			try {
				...
				if (ercCompanyEntry != null) {
					...
					entityCache.putResult(
						ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
						ERCCompanyEntryImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception exception) {
				entityCache.removeResult(
	...
	@Override
	public Map<Serializable, ERCCompanyEntry> fetchByPrimaryKeys(
		...
		Map<Serializable, ERCCompanyEntry> map =
			new HashMap<Serializable, ERCCompanyEntry>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (ercCompanyEntry != null) {
				map.put(primaryKey, ercCompanyEntry);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (ERCCompanyEntry)serializable);
				}
			}
		}
		...
		sb.append(_SQL_SELECT_ERCCOMPANYENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (ERCCompanyEntry ercCompanyEntry :
					(List<ERCCompanyEntry>)query.list()) {

				map.put(ercCompanyEntry.getPrimaryKeyObj(), ercCompanyEntry);

				cacheResult(ercCompanyEntry);

				uncachedPrimaryKeys.remove(ercCompanyEntry.getPrimaryKeyObj());
			}
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCCompanyEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCCompanyEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathCountAll = new FinderPath(
			ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCCompanyEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			ERCCompanyEntryModelImpl.UUID_COLUMN_BITMASK);
		...
		_finderPathWithoutPaginationFindByUuid_C = new FinderPath(
			...
			ERCCompanyEntryModelImpl.UUID_COLUMN_BITMASK |
			ERCCompanyEntryModelImpl.COMPANYID_COLUMN_BITMASK);
		...
		_finderPathFetchByC_ERC = new FinderPath(
			ERCCompanyEntryModelImpl.ENTITY_CACHE_ENABLED,
			ERCCompanyEntryModelImpl.FINDER_CACHE_ENABLED,
			ERCCompanyEntryImpl.class, FINDER_CLASS_NAME_ENTITY, "fetchByC_ERC",
			new String[] {Long.class.getName(), String.class.getName()},
			ERCCompanyEntryModelImpl.COMPANYID_COLUMN_BITMASK |
			ERCCompanyEntryModelImpl.EXTERNALREFERENCECODE_COLUMN_BITMASK);
	...
	private static final String _SQL_SELECT_ERCCOMPANYENTRY_WHERE_PKS_IN =
		"SELECT ercCompanyEntry FROM ERCCompanyEntry ercCompanyEntry WHERE ercCompanyEntryId IN (";
...
// LIFERAY-SERVICE-BUILDER-HASH:1418641105