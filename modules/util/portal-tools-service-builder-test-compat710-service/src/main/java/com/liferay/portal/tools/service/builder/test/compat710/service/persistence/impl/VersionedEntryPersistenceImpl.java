...
import com.liferay.portal.tools.service.builder.test.compat710.exception.NoSuchVersionedEntryException;
import com.liferay.portal.tools.service.builder.test.compat710.model.VersionedEntry;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.VersionedEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.VersionedEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.VersionedEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.VersionedEntryUtil;
...
public class VersionedEntryPersistenceImpl
	...
	public Map<Serializable, VersionedEntry> fetchByPrimaryKeys(
		...
		sb.append(_SQL_SELECT_VERSIONEDENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (VersionedEntry versionedEntry :
					(List<VersionedEntry>)query.list()) {
...
// LIFERAY-SERVICE-BUILDER-HASH:-729852071