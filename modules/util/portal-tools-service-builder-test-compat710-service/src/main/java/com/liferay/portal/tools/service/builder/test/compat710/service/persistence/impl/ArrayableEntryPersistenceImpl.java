...
import com.liferay.portal.tools.service.builder.test.compat710.exception.NoSuchArrayableEntryException;
import com.liferay.portal.tools.service.builder.test.compat710.model.ArrayableEntry;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ArrayableEntryImpl;
import com.liferay.portal.tools.service.builder.test.compat710.model.impl.ArrayableEntryModelImpl;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ArrayableEntryPersistence;
import com.liferay.portal.tools.service.builder.test.compat710.service.persistence.ArrayableEntryUtil;
...
public class ArrayableEntryPersistenceImpl
	...
	public void cacheResult(ArrayableEntry arrayableEntry) {
		entityCache.putResult(
			ArrayableEntryModelImpl.ENTITY_CACHE_ENABLED,
	...
	public ArrayableEntry updateImpl(ArrayableEntry arrayableEntry) {
		...
		if (!ArrayableEntryModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
			Object[] args = new Object[] {arrayableEntryModelImpl.getGroupId()};
			...
			if ((arrayableEntryModelImpl.getColumnBitmask() &
				 _finderPathWithoutPaginationFindByGroupId.
					 getColumnBitmask()) != 0) {

				Object[] args = new Object[] {
					arrayableEntryModelImpl.getOriginalGroupId()
				};
				...
				args = new Object[] {arrayableEntryModelImpl.getGroupId()};
	 ...
	 */
	@Override
	public ArrayableEntry fetchByPrimaryKey(Serializable primaryKey) {
		...
		ArrayableEntry arrayableEntry = (ArrayableEntry)serializable;
		...
		if (arrayableEntry == null) {
			...
			try {
				...
				if (arrayableEntry != null) {
					...
					entityCache.putResult(
						ArrayableEntryModelImpl.ENTITY_CACHE_ENABLED,
						ArrayableEntryImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception exception) {
				entityCache.removeResult(
	...
	public Map<Serializable, ArrayableEntry> fetchByPrimaryKeys(
		...
		Map<Serializable, ArrayableEntry> map =
			new HashMap<Serializable, ArrayableEntry>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (arrayableEntry != null) {
				map.put(primaryKey, arrayableEntry);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (ArrayableEntry)serializable);
				}
			}
		}
		...
		sb.append(_SQL_SELECT_ARRAYABLEENTRY_WHERE_PKS_IN);
		...
		try {
			...
			for (ArrayableEntry arrayableEntry :
					(List<ArrayableEntry>)query.list()) {

				map.put(arrayableEntry.getPrimaryKeyObj(), arrayableEntry);

				cacheResult(arrayableEntry);

				uncachedPrimaryKeys.remove(arrayableEntry.getPrimaryKeyObj());
			}
	...
	public void afterPropertiesSet() {
		...
		_finderPathWithPaginationFindAll = new FinderPath(
			ArrayableEntryModelImpl.ENTITY_CACHE_ENABLED,
			ArrayableEntryModelImpl.FINDER_CACHE_ENABLED,
			ArrayableEntryImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findAll", new String[0]);

		_finderPathWithoutPaginationFindAll = new FinderPath(
			ArrayableEntryModelImpl.ENTITY_CACHE_ENABLED,
			ArrayableEntryModelImpl.FINDER_CACHE_ENABLED,
			ArrayableEntryImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findAll", new String[0]);

		_finderPathCountAll = new FinderPath(
			ArrayableEntryModelImpl.ENTITY_CACHE_ENABLED,
			ArrayableEntryModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathWithoutPaginationFindByGroupId = new FinderPath(
			...
			ArrayableEntryModelImpl.GROUPID_COLUMN_BITMASK |
			ArrayableEntryModelImpl.INTEGER_COLUMN_BITMASK |
			ArrayableEntryModelImpl.TYPE_COLUMN_BITMASK);
	...
	private static final String _SQL_SELECT_ARRAYABLEENTRY_WHERE_PKS_IN =
		"SELECT arrayableEntry FROM ArrayableEntry arrayableEntry WHERE arrayableEntryId IN (";
...
// LIFERAY-SERVICE-BUILDER-HASH:-184495953