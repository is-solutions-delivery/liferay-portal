...
public class TestrayCaseResult implements Serializable {
	...
	@Schema
	public String getTestrayUserImgUrl() {
		if (_testrayUserImgUrlSupplier != null) {
			testrayUserImgUrl = _testrayUserImgUrlSupplier.get();

			_testrayUserImgUrlSupplier = null;
		}

		return testrayUserImgUrl;
	}

	public void setTestrayUserImgUrl(String testrayUserImgUrl) {
		this.testrayUserImgUrl = testrayUserImgUrl;

		_testrayUserImgUrlSupplier = null;
	}

	@JsonIgnore
	public void setTestrayUserImgUrl(
		UnsafeSupplier<String, Exception> testrayUserImgUrlUnsafeSupplier) {

		_testrayUserImgUrlSupplier = () -> {
			try {
				return testrayUserImgUrlUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String testrayUserImgUrl;

	@JsonIgnore
	private Supplier<String> _testrayUserImgUrlSupplier;

	@Schema
	public String getTestrayUserName() {
		if (_testrayUserNameSupplier != null) {
			testrayUserName = _testrayUserNameSupplier.get();

			_testrayUserNameSupplier = null;
		}

		return testrayUserName;
	}

	public void setTestrayUserName(String testrayUserName) {
		this.testrayUserName = testrayUserName;

		_testrayUserNameSupplier = null;
	}

	@JsonIgnore
	public void setTestrayUserName(
		UnsafeSupplier<String, Exception> testrayUserNameUnsafeSupplier) {

		_testrayUserNameSupplier = () -> {
			try {
				return testrayUserNameUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected String testrayUserName;

	@JsonIgnore
	private Supplier<String> _testrayUserNameSupplier;
	...
	public String toString() {
		...
		String testrayUserImgUrl = getTestrayUserImgUrl();

		if (testrayUserImgUrl != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"testrayUserImgUrl\": ");

			sb.append("\"");

			sb.append(_escape(testrayUserImgUrl));

			sb.append("\"");
		}

		String testrayUserName = getTestrayUserName();

		if (testrayUserName != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}

			sb.append("\"testrayUserName\": ");

			sb.append("\"");

			sb.append(_escape(testrayUserName));
