...
@Generated("")
@ProviderType
public interface TestrayCaseResultResource {
	...
	public Page<TestrayCaseResult> getTestrayCaseResultHistoryTestrayCasePage(
			...
			String issues, Boolean issuesBlankOnly, String maxExecutionDate,
			String minExecutionDate, String status,
			String testrayProductVersionIds, String testrayRoutineIds,
			String testrayRunName, String testrayTeamIds, String testrayUserId,
			String warning, Pagination pagination)
		throws Exception;
	...
	public Page<TestrayCaseResult> getTestrayCaseResultsTestrayBuildPage(
			...
			String error, Boolean errorBlankOnly, String issues,
			Boolean issuesBlankOnly, String priority, String status,
	...
	public interface Builder {
		...
		public TestrayCaseResultResource build();
