...
public class CompareRuns implements Serializable {
	...
	@JsonIgnore
	public void setView(UnsafeSupplier<String, Exception> viewUnsafeSupplier) {
		_viewSupplier = () -> {
			try {
	...
	@JsonIgnore
	private Supplier<String> _viewSupplier;
	...
	@Schema(
		...
		defaultValue = "com.liferay.testray.rest.dto.v1_0.CompareRuns",
		name = "x-class-name"
	)
