...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {testrayRunComparison(testrayRun1Id: ___, testrayRun2Id: ___){results}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
