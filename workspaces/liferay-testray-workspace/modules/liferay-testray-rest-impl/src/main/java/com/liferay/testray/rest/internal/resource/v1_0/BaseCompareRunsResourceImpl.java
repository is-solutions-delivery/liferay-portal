...
public abstract class BaseCompareRunsResourceImpl
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/testray-rest/v1.0/compare-runs/{testrayRunId1}/{testrayRunId2}'  -u 'test@liferay.com:test'
	 */
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/compare-runs/{testrayRunId1}/{testrayRunId2}")
