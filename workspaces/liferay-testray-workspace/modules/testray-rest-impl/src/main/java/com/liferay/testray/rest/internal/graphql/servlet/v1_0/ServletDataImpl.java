...
import com.liferay.testray.rest.internal.resource.v1_0.TestrayRoutineMetricResourceImpl;
...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		...
		Query.setTestrayRoutineMetricResourceComponentServiceObjects(
			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						...
						new ObjectValuePair<>(
							TestrayRoutineMetricResourceImpl.class,
