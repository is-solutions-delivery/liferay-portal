...
import com.liferay.testray.rest.internal.resource.v1_0.TestrayDurationReportResourceImpl;
...
public class ServletDataImpl implements ServletData {
	...
	public void activate(BundleContext bundleContext) {
		...
		Query.setTestrayDurationReportResourceComponentServiceObjects(
			...
			new HashMap<String, ObjectValuePair<Class<?>, String>>() {
				{
					...
					put(
						"query#testrayDurationReportsTestrayRoutine",
						new ObjectValuePair<>(
							TestrayDurationReportResourceImpl.class,
