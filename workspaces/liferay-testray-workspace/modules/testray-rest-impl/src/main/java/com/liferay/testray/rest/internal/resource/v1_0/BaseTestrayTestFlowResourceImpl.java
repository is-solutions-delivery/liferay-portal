...
public abstract class BaseTestrayTestFlowResourceImpl
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/testray-rest/v1.0/testray-testflow/{testrayTaskId}/testray-subtask'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.Parameters(
		value = {
			@io.swagger.v3.oas.annotations.Parameter(
	...
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/testray-testflow/{testrayTaskId}/testray-subtask")
	@javax.ws.rs.Produces({"application/json", "application/xml"})
	@Override
