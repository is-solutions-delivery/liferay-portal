...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {testrayCaseResultHistoryTestrayCase(error: ___, errorBlankOnly: ___, issues: ___, issuesBlankOnly: ___, maxExecutionDate: ___, minExecutionDate: ___, page: ___, pageSize: ___, status: ___, testrayCaseId: ___, testrayProductVersionIds: ___, testrayRoutineIds: ___, testrayRunName: ___, testrayTeamIds: ___, testrayUserId: ___, warning: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public TestrayCaseResultPage testrayCaseResultHistoryTestrayCase(
			...
			@GraphQLName("errorBlankOnly") Boolean errorBlankOnly,
			@GraphQLName("issues") String issues,
			@GraphQLName("issuesBlankOnly") Boolean issuesBlankOnly,
			...
			@GraphQLName("testrayUserId") String testrayUserId,
			...
			testrayCaseResultResource -> new TestrayCaseResultPage(
				testrayCaseResultResource.
					getTestrayCaseResultHistoryTestrayCasePage(
						testrayCaseId, error, errorBlankOnly, issues,
						issuesBlankOnly, maxExecutionDate, minExecutionDate,
						status, testrayProductVersionIds, testrayRoutineIds,
						testrayRunName, testrayTeamIds, testrayUserId, warning,
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {testrayCaseResultsTestrayBuild(comment: ___, commentBlankOnly: ___, error: ___, errorBlankOnly: ___, issues: ___, issuesBlankOnly: ___, page: ___, pageSize: ___, priority: ___, status: ___, testrayBuildId: ___, testrayCaseName: ___, testrayCaseTypeIds: ___, testrayComponentIds: ___, testrayRunId: ___, testrayRunName: ___, testrayTeamIds: ___, testrayUserId: ___){items {__}, page, pageSize, totalCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
	public TestrayCaseResultPage testrayCaseResultsTestrayBuild(
			...
			@GraphQLName("commentBlankOnly") Boolean commentBlankOnly,
			@GraphQLName("error") String error,
			@GraphQLName("errorBlankOnly") Boolean errorBlankOnly,
			@GraphQLName("issues") String issues,
			@GraphQLName("issuesBlankOnly") Boolean issuesBlankOnly,
		...
		return _applyComponentServiceObjects(
			...
			testrayCaseResultResource -> new TestrayCaseResultPage(
				testrayCaseResultResource.getTestrayCaseResultsTestrayBuildPage(
					testrayBuildId, comment, commentBlankOnly, error,
					errorBlankOnly, issues, issuesBlankOnly, priority, status,
					testrayCaseName, testrayCaseTypeIds, testrayComponentIds,
					testrayRunId, testrayRunName, testrayTeamIds, testrayUserId,
					Pagination.of(page, pageSize))));
	}
