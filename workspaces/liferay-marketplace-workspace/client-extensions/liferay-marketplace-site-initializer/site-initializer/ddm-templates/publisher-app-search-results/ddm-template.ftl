...
<#assign
	baseURL = "https://marketplace-uat.liferay.com"
...
<#assign
	...
	requestUrl = requestUrl + "&pageSize=" + delta
	requestUrl = requestUrl + "&page=" + start
...
<#if catalogApps?has_content && catalogApps.items?has_content>
	...
	<#assign
		currentPage = catalogApps.page
		pageSize = catalogApps.pageSize
		totalCount = catalogApps.totalCount
		totalPages = (totalCount / pageSize)?ceiling
	/>
		...
		<div class="pagination-bar">
			...
			<#assign
				...
				endItem = [(currentPage * pageSize), totalCount]?min
			/>
