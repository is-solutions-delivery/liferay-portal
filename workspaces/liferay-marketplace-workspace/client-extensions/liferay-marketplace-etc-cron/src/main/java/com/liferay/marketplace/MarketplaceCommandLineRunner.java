...
public class MarketplaceCommandLineRunner
	...
	private com.liferay.headless.admin.user.client.pagination.Page<UserAccount>
			_getUserGroupUsersPage(String userFilter, String userGroupFilter)
		throws Exception {
		...
		return userAccountResource.getUserGroupUsersPage(
	...
	private void _processLiferayStaffUserGroups() throws Exception {
		...
		com.liferay.headless.admin.user.client.pagination.Page<UserAccount>
			userGroupUsersPage = _getUserGroupUsersPage(
				null, "name eq 'Employees'");

		for (UserAccount userAccount : userGroupUsersPage.getItems()) {
