...
import ResourceRequirements from '../ProvideAppBuildPage/ResourceRequirements';
import { offeringTypesDescription } from '../ProvideAppBuildPage/constants/offeringTypesDescriptions';
import UploadAppPackagesComponent from '../ProvideAppBuildPage/components/UploadAppPackages';
...
const AppType: React.FC<ProvideAppBuildPageProps> = ({
    onClickBack,
    onClickContinue,
}) => {
