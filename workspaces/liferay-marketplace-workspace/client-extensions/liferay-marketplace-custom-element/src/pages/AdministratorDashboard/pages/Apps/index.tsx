...
export default function Apps() {
	...
	const appsTest = useAppsMetricks('week')
	...
	return (<>
		<div className="d-flex flex-wrap mb-3">
			<InfoCard
				className='mr-3'
				expanded
				growth={percentage(appsTest.allApps, appsTest.approvedLastWeek - appsTest.approvedBeforeLastWeek)}
				growthContext={`+${appsTest.approvedLastWeek - appsTest.approvedBeforeLastWeek} this week`}
				symbol="squares-clock"
				title="App Awaiting Review"
				value={appsTest.approved}
			/>

			<InfoCard
				expanded
				growth={percentage(appsTest.inReview, appsTest.inreviewLastlastweek - appsTest.inreviewBeforeLastWeek)}
				growthContext={`+${appsTest.inreviewLastlastweek - appsTest.inreviewBeforeLastWeek} this week`}
				symbol="squares"
				title="Recently Published"
				value={appsTest.inReview}
			/>
		</div>
		<Page
