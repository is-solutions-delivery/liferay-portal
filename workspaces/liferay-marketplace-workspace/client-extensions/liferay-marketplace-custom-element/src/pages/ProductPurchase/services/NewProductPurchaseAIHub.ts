...
type NewAIHubForm = z.infer<typeof zodSchema.newAIHubForm>;

export class NewProductPurchaseAIHub extends ProductPurchase {
	private form?: NewAIHubForm;
	protected orderTypeExternalReferenceCode = OrderTypes.AI_HUB;

	setForm(form: NewAIHubForm) {
		this.form = form;
	}
