...
type LiferayAIHubNextStepsProps = {
...
const LiferayAIHubNextSteps: React.FC<LiferayAIHubNextStepsProps> = ({
	data,
	error,
	isLoading,
}: LiferayAIHubNextStepsProps) => {
...
export default LiferayAIHubNextSteps;
