...
import {PURPOSE_OPTIONS} from '../../LiferayProduct/ActivationKeyForm/constants';

import './LiferayAIHubForm.scss';

const LiferayAIHubForm = () => {
	...
	const {
		...
		setValue,
		watch,
	} = useForm<z.infer<typeof zodSchema.aiHubProvisioning>>({
		defaultValues: {
			administrationEmail: '',
			aiHubAccountName: '',
			businessEmail: '',
		...
		resolver: zodResolver(zodSchema.aiHubProvisioning),
	});
	...
	const onSubmit = async (
		data: z.infer<typeof zodSchema.aiHubProvisioning>
	) => {
		setLoading(true);
	...
	return (
		...
		>
			...
			<ClayForm.Group>
				...
				{purpose === 'other' && (
					<textarea
						className="custom-input liferay-ai-hub-form-textarea mt-5 rounded-lg w-100"
				...
				<p className="liferay-ai-hub-form-aggreements-text">
					...
					<a
						className="ml-1"
						href="https://marketplace-uat.liferay.com/documents/d/marketplace/evaluation-agreement-cloud-services-1202603_gl"
						target="_blank"
					>
						this agreement
					</a>
...
export default LiferayAIHubForm;
