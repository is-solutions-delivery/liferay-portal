...
const NewAIHubForm = () => {
	...
	const {
		...
		setValue,
		watch,
	} = useForm<z.infer<typeof zodSchema.newAIHubForm>>({
		defaultValues: {
		...
		resolver: zodResolver(zodSchema.newAIHubForm),
	});
	...
	const onSubmit = async (form: z.infer<typeof zodSchema.newAIHubForm>) => {
