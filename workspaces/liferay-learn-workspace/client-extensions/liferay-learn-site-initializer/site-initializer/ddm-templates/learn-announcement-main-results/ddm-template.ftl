...
<#assign
	taxonomyVocabylaryId = restClient.get("/headless-admin-taxonomy/v1.0/sites/${themeDisplay.getCompanyGroupId()}/taxonomy-vocabularies/by-external-reference-code/41084753-a2d3-9f9a-12c8-8ebcf85949f6?fields=id").id!0
