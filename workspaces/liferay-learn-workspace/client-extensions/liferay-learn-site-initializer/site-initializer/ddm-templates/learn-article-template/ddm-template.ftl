		...
		<div class="col-12 col-md-2 doc-nav-wrapper mobile-nav-hide">
			<div class="doc-nav-wrapper-inner">
				...
				<div class="doc-nav">
					...
					<#if !topLevelArticle>
						<a class="back-link btn btn-link btn-monospaced d-flex flex-row justify-content-start" href="${breadcrumbLinksJSONArray.getJSONObject.url}" id="backLink">
						...
						<ul class="current">
							<#if !topLevelArticle>
								<li class="current parent-level toctree-l1">
									<a class="reference internal" href="${breadcrumbLinksJSONArray.getJSONObject.url}">${breadcrumbLinksJSONArray.getJSONObject.title}</a>
								</li>
							</#if>
