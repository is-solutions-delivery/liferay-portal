...
<#assign
	journalId = .vars["reserved-article-id"].data
	articleCategories = restClient.get("/headless-delivery/v1.0/sites/${groupId}/structured-contents/by-key/${journalId}").taxonomyCategoryBriefs
	vocabularyList = []
/>
	...
	<div class="row">
		...
		<div class="col-12 col-md-10 doc-body">
			<div class="col-12 general-info p-md-0 position-static">
				<div class="border-bottom-0 col-12 h-auto info-bar p-0">
					<div class="col-12 col-md-8 mt-3 offset-md-1">
						...
						<div class="d-flex flex-column mt-2" id="tags">
