<#assign
	...
	response = restClient.get("/c/p2s3lessons/${assetEntryId}?fields=p2s3ModuleToP2S3Lessons.p2s3CourseToP2S3Modules.title&nestedFields=p2s3ModuleToP2S3Lessons,p2s3CourseToP2S3Modules&nestedFieldsDepth=2")
